...
const AdminActions = ({ transaction }) => {
  ...
  const cancelTransaction = () => {
    axios
      .patch(`/transfer/cancel/${transaction.id}`)
      .then((res) => {
        if (res.status === 200) {
